...
- [**Linear Algebra Student Aid Interface**](https://github.com/JeffreyWong05/Linear-Algebra-Student-Aid-Interface): A locally hosted website to help students perform various matrix calculations for their assignments. Various libraries and frameworks such as NumPy and Flask were used to run calculations in the backend, while the frontend used React to display the calculators.
- [**Plant Defense**](https://github.com/JeffreyWong05/Plant-Defense): A 2d game made in Unity for a 36 hour hackathon, with scripts written in C#.

## Get in Touch
- LinkedIn: https://www.linkedin.com/in/jeffreywong05/
- Email: jeffjeff217@hotmail.com
