...
- [**Linear Algebra Student Aid Interface**]: A locally hosted website to help students perform various matrix calculations for their assignments. Various libraries and frameworks such as NumPy and Flask were used to run calculations in the backend, while the frontend used React to display the calculators.
